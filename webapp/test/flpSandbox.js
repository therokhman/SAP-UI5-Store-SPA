		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#aliakseirakhmankoleverx-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aliakseirakhmankoleverx-display": {
								"semanticObject": "aliakseirakhmankoleverx",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aliaksei.rakhmanko",
									"url": sap.ui.require.toUrl("aliaksei/rakhmanko")
								}
							}
						}
					}
